...
class TransactionController extends Controller
{
    ...
    public function newTransaction(Request $r) {
        ...
        return response()->json(['status' => true, 'message' => '<b>Transaction Successful!</b> <br>Total Price: <b>Gh₵'.number_format($totalPrice)."</b><br>Payment Amount: <b>Gh₵ ".number_format($r->bayar)."</b><br>Change: <b>Gh₵ ".number_format($r->kembalian)."</b><br>Invoice: <a href='".url("transaksi/invoice/".$order->invoice)."'>Click here</a>"]);
    }
